...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {/* Sign In Button (Opens real bcrypt login) */}
              <button
                onClick={() => setIsAuthModalOpen(true)}
                className="hidden md:inline-flex items-center gap-1 px-3 py-1.5 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-semibold transition-all"
                title="Sign in with bcrypt password verification"
              >
      ...
      {/* Auth Modal for bcrypt registration & sign in */}
